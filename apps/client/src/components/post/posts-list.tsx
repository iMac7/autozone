...
import { z } from "zod";
import { evmAddress, postId, PostReactionType, PostReferenceType, PostType, uri } from "@lens-protocol/client";
import { handleWith } from "@lens-protocol/client/viem";
import { walletClient } from "@/utils/viem";
import { post as _post, fetchPost, fetchPosts, fetchPostReferences } from "@lens-protocol/client/actions";
    ...
    return (
        <>
            ...
            <Button
                ...
                className='bg-white w-[3rem] h-[3rem] hover:bg-gray-200 fixed bottom-6 right-6'>
...
function PostModal({ post, setSelectedPost }: any) {
    ...
    return (
        <div
            className="bg-white top-[12rem] fixed w-full md:max-w-[48vw] shadow-lg h-[80vh] px-6 py-4 hover:shadow-xl transition-shadow rounded border-2 border-gray-200"
        >
